  ...
  .user-card{
    ...
    .card__actions{
      ...
      .ant-btn-white{
        ...
        &:hover{
          border: 1px solid ${({ theme }) => theme['primary-color']} !important;
        }
        svg{
...
const FaqWrapper = Styled.div`
  ...
  .ant-collapse-content{
    ...
    .ant-collapse-content-box{
      border-top: 1px solid ${({ theme }) => theme[theme.mainContent]['light-border']} !important;
...
const TermsConditionsStyle = Styled.div`
  .ninjadash-term-condition-top{
    ...
    align-items: center;
    border-radius: 10px;
    background-color: ${({ theme }) => theme[theme.mainContent]['primary-white-15']};
  ...
  .ninjadash-term-condition-content{
    ...
    background-color: ${({ theme }) => theme[theme.mainContent]['white-background']};
    box-shadow: 0 10px 50px ${({ theme }) => theme[theme.mainContent]['light-text']}20;
    max-width: 770px;
    border-radius: 10px;
